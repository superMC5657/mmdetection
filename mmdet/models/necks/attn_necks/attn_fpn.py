...
from ..fpn import FPN
from ...attn_module.dma_fpn import FPNAttentionUp, FPNAttentionUpV2, FPNAttentionUpV3
    ...
    def __init__(self,
        ...
        for i in range(self.start_level, self.backbone_end_level):
            ...
            if i == self.backbone_end_level - 1:
                self_conv = False
            self.fpn_attn_up.append(
                FPNAttentionUpV2(out_channels, upsample_cfg=self.upsample_cfg, up_conv=up_conv, self_conv=self_conv))
        self.attention = ScaledDotProductAttention(out_channels ** 0.5)
